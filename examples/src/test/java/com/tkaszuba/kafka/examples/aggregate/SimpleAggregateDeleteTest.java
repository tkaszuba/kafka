...
import com.tkaszuba.kafka.streams.examples.aggregate.SimpleAggregateDelete;
...
public class SimpleAggregateDeleteTest {
  ...
  public void setup() {
    ...
    SimpleAggregateDelete.createStream(builder);
    ...
    inputTopic =
        testDriver.createInputTopic(
            SimpleAggregateDelete.Incoming, stringSerde.serializer(), integerSerde.serializer());
    outputTopic =
        testDriver.createOutputTopic(
            SimpleAggregateDelete.Outgoing,
